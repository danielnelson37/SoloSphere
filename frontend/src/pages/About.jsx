  ...
  return (
    <div className="about-container">
      <header className="about-header">
        ...
        <p>Curated by artist Daniel Nelson. An exploration of existential themes that navigate the delicate dance between absurdism, nihilism, and existentialism. SOLISPHERE is more than a gallery; it's a curated space that transcends artistic boundaries. It's a digital sanctuary and a source of light for individuals seeking a fresh start and meaningful connections through art and technology.</p>
        </section>
      </header>

      <section className="introduction-row-1">
        <section className="introduction">
        <h2>THE FACE</h2>
        <img src="/images/portrait.JPG" alt="desc"/>
        <p>
          Greetings, I'm Daniel Nelson, an artist whose creative journey traverses the realms of fine arts, graphic design, and software engineering. With a foundation nurtured at the Parsons School of Art & Design and honed during the Software Engineering Fellowship at The Marcy Lab School, my approach seamlessly bridges aesthetics and functionality that portrays the beauty found in introspection, navigating the complexities of morality, existence, and the pursuit of personal wholeness.
        </p>
        </section>
      ...
      <section className="introduction-row-2">
